            ...
            columns: [
                {
                    ...
                    boardId: 'board-1',
                    title: 'To do column',
                    cardOrder: ['card-1', 'card-2', 'card-3', 'card-4', 'card-5', 'card-6', 'card-7', 'card-7.1', 'card-7.2','card-7.3'],
                    cards: [
                        { id: 'card-1', boardId: 'board-1', columnId: 'column-1', title: 'Title of card 1', cover: 'https://images.unsplash.com/photo-1485356824219-4bc17c2a2ea7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1169&q=80' },
                        ...
                        { id: 'card-7.1', boardId: 'board-1', columnId: 'column-1', title: 'Title of card 7.1', cover: null },
                        { id: 'card-7.2', boardId: 'board-1', columnId: 'column-1', title: 'Title of card 7.2', cover: null },
                        { id: 'card-7.3', boardId: 'board-1', columnId: 'column-1', title: 'Title of card 7.3', cover: null },
                    ]
                },
