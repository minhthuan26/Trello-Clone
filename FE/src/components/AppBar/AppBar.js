...
function AppBar() {
  ...
  let axiosJWTgetUsers = createAxios(user, dispatch, loginSuccess);
  ...
  useEffect(() => {
    ...
    if (user?.accessToken) {
      getAllUser(accessToken, dispatch, axiosJWTgetUsers);
    }
  });
                ...
                <Col sm={5} xs={12} className="col-no-padding">
                  ...
                  <div className="user-actions">
                    <Link className="link" to={'/login'}>
                      <Button className="re-button">Login</Button>
                    </Link>
                    <Link className="link" to={'/register'}>
                      <Button className="re-button">Register</Button>
                    </Link>
                  </div>
                </Col>
              </Row>
